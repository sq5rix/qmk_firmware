...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
 ...
 [_BEAKL15] = LAYOUT(
  ...
  [_LOWER] = LAYOUT(
     RESET,   KC_F4,   KC_F10,  KC_F1,   KC_F2,   KC_F3,                              KC_F7,   KC_F6,   KC_F5,   KC_F9,   KC_F8,   _______, 
     _______, _______, _______, _______, _______, _______,                            KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_PGDN,
     _______, KC_BSLS, KC_LPRN, KC_DQT,  KC_RPRN, KC_HASH,                            RGB_HUD, KC_P4,   KC_P5,   KC_P6,   KC_PLUS, KC_HOME,
     BL_STEP, BEAKL15, QWERTY,  KC_COLN, KC_ASTR, KC_PLUS, _______,                   KC_RPRN, KC_RCBR, KC_P1,   KC_P2,   KC_P3,   KC_MINS, KC_END,

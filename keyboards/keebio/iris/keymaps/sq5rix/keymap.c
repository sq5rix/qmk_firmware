...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
 ...
 [_BASE] = LAYOUT(
  TG(_RAISE),  KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,                              KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_DEL,
     ...
     SH_UND,   LA_Y,    AL_I,    LG_E,    KC_A,    LT_DAT,                             KC_D,    KC_S,    AL_T,    RG_N,    RA_W,    SH_RABS,
 ...
 [_BEAKL15] = LAYOUT(
  ...
  [_RAISE] = LAYOUT(
     _______,  KC_VOLD, KC_VOLU, KC_MUTE, KC_BRIGHTNESS_DOWN, KC_BRIGHTNESS_UP,    KC_PSCREEN, _______, _______,  BASE, BEAKL15, RESET,
